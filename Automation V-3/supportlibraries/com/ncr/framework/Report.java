...
public class Report
{
  ...
  public void initializeTestLog()
  {
	  try {
		  ...
		  System.out.println("report types : "+this.reportTypes.size());
  ...
  public void updateTestLog(String stepName, String stepDescription, Status stepStatus) throws AWTException
  {
    ...
    if (stepStatus.ordinal() <= this.reportSettings.getLogLevel())
    {
      ...
      if ((stepStatus.equals(Status.FAIL)) && 
        ...
        screenshotName = this.reportSettings.getReportName() + "_" + 
          Util.getCurrentFormattedTime(this.reportSettings.getDateFormatString()).replace(" ", "_").replace(":", "-") + ".png";
  ...
  protected void takeScreenshot(String screenshotPath) throws AWTException
  {
